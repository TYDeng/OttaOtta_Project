...
function Playlist() {
  const [accordionItems, setAccordionItems] = useState([
    { id: 1, name: 'Gaming', content: 'This is my playlist for gaming videos', videos: videoData.slice(0, 5) },
  ]);
  ...
  return (
    <div className="col-10">
      <header className="d-flex justify-content-between align-items-center pt-5 mb-4">
        ...
        <Button variant="primary" onClick={() => handleShowModal()}>Add Playlist</Button>
      </header>
      {showHelpText && (
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        <Modal.Header closeButton>
          <Modal.Title>{currentItem ? 'Edit Playlist' : 'Add Playlist'}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
